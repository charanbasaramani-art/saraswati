...
const companies = [
  ...
  { id: 'Amazon', name: 'Amazon', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/amazon.svg', initials: 'A', color: 'from-orange-500 to-yellow-500' },
  { id: 'Microsoft', name: 'Microsoft', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/microsoft.svg', initials: 'MS', color: 'from-blue-600 to-cyan-500' },
  { id: 'Meta', name: 'Meta', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/meta.svg', initials: 'M', color: 'from-blue-500 to-indigo-600' },
  { id: 'Apple', name: 'Apple', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/apple.svg', initials: 'AP', color: 'from-gray-700 to-gray-500' },
  { id: 'Infosys', name: 'Infosys', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/infosys.svg', initials: 'IN', color: 'from-blue-600 to-blue-400' },
  { id: 'TCS', name: 'TCS', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/tata.svg', initials: 'TCS', color: 'from-purple-600 to-pink-500' },
  { id: 'Wipro', name: 'Wipro', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/wipro.svg', initials: 'W', color: 'from-green-600 to-teal-500' },
  { id: 'Accenture', name: 'Accenture', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/accenture.svg', initials: 'AC', color: 'from-purple-500 to-violet-600' },
  { id: 'IBM', name: 'IBM', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/ibm.svg', initials: 'IBM', color: 'from-blue-700 to-blue-500' },
  { id: 'Cognizant', name: 'Cognizant', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/cognizant.svg', initials: 'CG', color: 'from-blue-500 to-cyan-400' },
  { id: 'Oracle', name: 'Oracle', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/oracle.svg', initials: 'OR', color: 'from-red-600 to-red-400' },
  { id: 'HeteroLabs', name: 'Hetero Labs', logo: 'https://www.heterohealthcare.com/assets/img/logo.png', initials: 'HL', color: 'from-green-500 to-emerald-400' },
  { id: '247AI', name: '24/7 AI', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/247.svg', initials: '24', color: 'from-indigo-600 to-purple-500' },
  { id: 'Acmegrade', name: 'Acmegrade', logo: 'https://acmegrade.com/wp-content/uploads/2023/01/logo.png', initials: 'AG', color: 'from-teal-500 to-cyan-400' },
  { id: 'WNS', name: 'WNS Global', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/wns.svg', initials: 'WNS', color: 'from-blue-800 to-blue-600' },
  { id: 'Deloitte', name: 'Deloitte', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/deloitte.svg', initials: 'DL', color: 'from-green-700 to-green-500' },
  { id: 'Capgemini', name: 'Capgemini', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/capgemini.svg', initials: 'CG', color: 'from-blue-700 to-indigo-500' },
  { id: 'HCL', name: 'HCL Tech', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/hcl.svg', initials: 'HCL', color: 'from-blue-500 to-sky-400' },
  { id: 'TechMahindra', name: 'Tech Mahindra', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/techmahindra.svg', initials: 'TM', color: 'from-red-600 to-pink-500' },
];
